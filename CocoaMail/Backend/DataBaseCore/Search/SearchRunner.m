...
{
    DDLogInfo(@"-[SearchRunner performThreadSearch]");
...
//                NSLog(@"Group Fetch Duration: %f seconds.", timeElapsedG);
        ...
        DDLogInfo(@"\tEmails Fetch Duration: %f seconds. Groups: %lu", timeElapsed, (unsigned long)uidsInGroups.count);
